...
public final class ActivityDashboardBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView rvDashboardActivity;

  private ActivityDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppbarLayoutBinding appbar, @NonNull RecyclerView rvDashboardActivity) {
    this.rootView = rootView;
    this.appbar = appbar;
    this.rvDashboardActivity = rvDashboardActivity;
  }
  ...
  public static ActivityDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rvDashboardActivity;
      RecyclerView rvDashboardActivity = ViewBindings.findChildViewById(rootView, id);
      if (rvDashboardActivity == null) {
        break missingId;
      }

      return new ActivityDashboardBinding((ConstraintLayout) rootView, binding_appbar,
          rvDashboardActivity);
    }
